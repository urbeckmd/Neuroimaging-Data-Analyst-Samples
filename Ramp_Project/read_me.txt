...
IMAGE_LABELING.PY: This script labels and organizes the raw images so that the model can be trained on the processed images. "LabelMe", and MIT Software, was uses as the labeling tool.
